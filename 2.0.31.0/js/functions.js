...
$.fn.anim_Load_SceneTwo = function() {
    ...
    ringOne = new addCoinDots({
        ...
        dotCount:15,
        colors:["#00fcff"], //have as many or as few colors as you want.
    ...
    ringTwo = new addCoinDots({
        ...
        dotCount:20,
        colors:["#60fdff"], //have as many or as few colors as you want.
    ...
    ringThree = new addCoinDots({
        ...
        dotCount:25,
        colors:["#93fdff"], //have as many or as few colors as you want.
